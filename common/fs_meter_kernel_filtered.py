...
def merge_runtime_settings(args: argparse.Namespace) -> Dict[str, object]:
    ...
    if root_mnt_ns_source is None:
        root_mnt_ns_source_setting = settings_file_values.get("root_mnt_ns_source")
        root_mnt_ns_source = str(root_mnt_ns_source_setting) if root_mnt_ns_source_setting is not None else "pid1"
